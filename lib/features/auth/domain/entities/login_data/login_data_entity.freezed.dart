...
abstract class $LoginDataEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? email, String? uid, String? token});
}
...
class _$LoginDataEntityImpl implements _LoginDataEntity {
  const _$LoginDataEntityImpl({this.email, this.uid, this.token});
  ...
  @override
  String toString() {
    return 'LoginDataEntity(email: $email, uid: $uid, token: $token)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, email, uid, token);
